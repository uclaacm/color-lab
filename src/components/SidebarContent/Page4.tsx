...
export default function Page4(props:{setEnabled: (arg0: boolean)=> void}):JSX.Element {
  ...
  return(
    <div id="level-four" className="level">
      <div className="swatches">
        <Swatch r={correctRed} g={correctGreen} b={correctBlue} mystery={true} showRGB={false}></Swatch>
